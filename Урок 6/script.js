...
const listKeys = ['A', 'S', 'D', 'F', 'G','B','E','R','T','Y','U','I','O','P','H','J','K','L','Z','X','C','V','B','A','B','C','D','E','F','G','H','I','J','K','L','M','a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm','N', 'O', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z'];
let currentKey = ''; // Переменная для текущей падающей клавиши
let score = 0; // Переменная для хранения очков игрока
let timer = 30; // Время, отведенное на каждую клавишу
...
function startGame() {
    ...
    timer = 30; // Сбрасываем таймер на 30 секунд
